 ...
 */
function camping_form_system_theme_settings_alter(&$form, &$form_state) {

  $form['camping_settings']['breadcrumb'] = array(
    '#type' => 'fieldset',
    '#title' => t('Breadcrumb'),
    '#collapsible' => TRUE,
    '#collapsed' => FALSE,
  );
  $form['camping_settings']['breadcrumb']['breadcrumb_delimiter'] = array(
    '#type' => 'textfield',
  ...
  $form['camping_settings']['socialblock'] = array(
    '#type' => 'fieldset',
    '#title' => t('Social Icon'),
    '#collapsible' => TRUE,
    '#collapsed' => FALSE,
  );
  $form['camping_settings']['socialblock']['social_block'] = array(
    '#type' => 'checkbox',
    '#title' => t('Show Social Icons'),
    '#default_value' => theme_get_setting('social_block', 'camping'),
    '#description'   => t("Check this option to show Social Icons."),
  );
  $form['camping_settings']['socialblock']['twitter_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Twitter Profile URL'),
    '#default_value' => theme_get_setting('twitter_url', 'camping'),
    '#description'   => t("Enter your Twitter Profile URL. Leave blank to hide."),
  );
  $form['camping_settings']['socialblock']['facebook_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Facebook Profile URL'),
    '#default_value' => theme_get_setting('facebook_url', 'camping'),
    '#description'   => t("Enter your Facebook Profile URL. Leave blank to hide."),
  );
  $form['camping_settings']['socialblock']['gplus_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Google Plus Address'),
    '#default_value' => theme_get_setting('gplus_url', 'camping'),
    '#description'   => t("Enter your Google Plus URL. Leave blank to hide."),
  );
  $form['camping_settings']['socialblock']['pinterest_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Pinterest Address'),
    '#default_value' => theme_get_setting('pinterest_url', 'camping'),
  ...
  $form['camping_settings']['carousel'] = array(
    '#type' => 'fieldset',
  ...
  if (module_exists('jquery_update')) {
    ...
    $form['camping_settings']['carousel']['carousel_enabled'] = array(
      '#type' => 'checkbox',
      '#title' => t('Enable the Bootstrap Carousel'),
      '#default_value' => $carousel_enabled,
    );

    $form['camping_settings']['carousel']['arrow_enabled'] = array(
      '#type' => 'checkbox',
      '#title' => t('Display next/previous arrows'),
      '#default_value' => theme_get_setting('arrow_enabled'),
    );

    $form['camping_settings']['carousel']['bullets_enabled'] = array(
      '#type' => 'checkbox',
    ...
    $form['camping_settings']['carousel']['slide_count'] = array(
      '#type' => 'select',
    ...
    for ($index = 1; $index <= $slide_count + 1; $index++) {
      $form['camping_settings']['carousel']['slide_' . $index] = array(
        '#type' => 'fieldset',
        '#title' => t('Slide') . ' ' . $index,
        '#collapsible' => TRUE,
        '#collapsed' => FALSE,
      ...
      $form['camping_settings']['carousel']['slide_' . $index]['carousel_image_' . $index] = array(
        '#title' => t('Image File') . ' ' . $index,
        '#type' => 'managed_file',
        '#default_value' => theme_get_setting('carousel_image_' . $index),
        '#upload_location' => 'public://camping_slides/',
      );
      $form['camping_settings']['carousel']['slide_' . $index]['carousel_alt_text_' . $index] = array(
      ...
      $form['camping_settings']['carousel']['slide_' . $index]['slide_caption_' . $index] = array(
        '#title' => t('Slide Caption') . ' ' . $index,
        '#type' => 'textarea',
        '#default_value' => theme_get_setting('slide_caption_' . $index),
      );
      $theme_settings_path = drupal_get_path('theme', 'camping') . '/theme-settings.php';
      ...
      $form['#submit'][] = 'camping_form_system_theme_settings_submit';
    }
  }
  else {
 ...
 */
function camping_form_system_theme_settings_submit(&$form, &$form_state) {
  global $user;
