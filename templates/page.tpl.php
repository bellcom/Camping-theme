...
?>
  ...
  <div id="page-wrapper" class="container"><div id="page">
    <div class="social-block">
      <?php if (theme_get_setting('social_block', 'camping')): ?>
            <ul class="social">
    ...
    <div id="header"><div class="section clearfix row">
     <!-- Yani:bellcom add top header her -->
      ...
      <div id="navigation" class=""><div class="section">
      <div class="main-menu">   <?php print theme('links__system_main_menu', array(
          'links' => $main_menu,
          'attributes' => array(
            'id' => 'main-menu',
            'class' => array(
    ...
    <div id="main-wrapper" class="row"><div id="main" class="clearfix">
      ...
      <?php if ($page['sidebar_first']): ?>
        <div id="sidebar" class="column sidebar span"><div class="section">
