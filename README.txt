...
Framework Methods
=================
Framework option settings are avaialbe at appearance -> settings -> camping
...
=====================
During the version upgrade the entire Camping theme folder will be replaced with
a new copy of the code, make sure you backup the Camping/libraries/bootstrap
